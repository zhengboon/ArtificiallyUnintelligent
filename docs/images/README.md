...
Photos used by the GitHub Pages site. All shot at BrainHack 2026 RoboVerse Drone Challenge finals, Marina Bay Sands Expo Level 4, 10–11 June 2026.
...
| `frontier-exploration-bonus.jpg` | `engineering.md` (bonus side-quest) | Phone screenshot of the Brainhack Frontier Exploration System, 3/3 zones explored |

Total size: ~6.7 MB across 6 photos. None are below-the-fold heavy.
